...
/*******************************************************************************
 * nand_detect_test - Detect NAND flash with it’s geometry and prints details.
 *
 * DESCRIPTION:
...
/*******************************************************************************
 * nand_badblock_test - Prints all bad blocks on NAND memory
 *
 * DESCRIPTION:
...
/*******************************************************************************
 * nand_readwrite_test - Performs read-write test on NAND chip.
 *
 * DESCRIPTION:
